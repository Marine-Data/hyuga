...
// v48 = carnet : section Défis // v47 = carnet : vidéo de la mission de Marine (compliment à Nawaëlle) intégrée. quêtes + vidéo du défi de Chunfei.
const CACHE_VERSION = 'saraillon-v48';
const APP_SHELL = [
  './',
  './index.html',
  './carnet.html',
